...
public class SymbolTest {
    ...
    public void testFuturesShortSymbol() {
        // March 31
        assertEquals("NGH1", new Symbol("NGH31").getShortSymbolForDisplay(2021, 8));

        // June 31
        assertEquals("NGM1", new Symbol("NGM31").getShortSymbolForDisplay(2021, 8));

        // July 31
        assertEquals("NGN1", new Symbol("NGN31").getShortSymbolForDisplay(2021, 8));

        // August 31
        assertEquals("NGO1", new Symbol("NGQ31").getShortSymbolForDisplay(2021, 8));

        // Sept 31
        assertEquals("NGP1", new Symbol("NGU31").getShortSymbolForDisplay(2021, 8));

        // March 41
        assertEquals("NGC1", new Symbol("NGH41").getShortSymbolForDisplay(2021, 8));

        // June 41
        assertEquals("NGI1", new Symbol("NGM41").getShortSymbolForDisplay(2021, 8));

        // July 41
        assertEquals("NGL1", new Symbol("NGN41").getShortSymbolForDisplay(2021, 8));
    }

    @Test
    public void testOptionsShortSymbol() {
        // March 31
        assertEquals("NGC1300C", new Symbol("NGC1300C", 2022, 9).getShortSymbolForDisplay(2022, 9));
        assertEquals("CLG1300D", new Symbol("CLG1300D", 2022, 9).getShortSymbolForDisplay(2022, 9));

        assertEquals("CLG1300D", new Symbol("CLG3|1300C", 2022, 9).getShortSymbolForDisplay(2022, 9));
        assertEquals("CLG1300D", new Symbol("CLG23|1300C", 2022, 9).getShortSymbolForDisplay(2022, 9));

        // March 31
        assertEquals("NGH1300C", new Symbol("NGH31|1300C", 2021, 8).getShortSymbolForDisplay(2021, 8));

        assertEquals("NGH1300C", new Symbol("NGH1|1300C", 2021, 8).getShortSymbolForDisplay(2021, 8));

        // June 31
        assertEquals("NGM1300C", new Symbol("NGM31|1300C", 2021, 8).getShortSymbolForDisplay(2021, 8));

        // July 31
        assertEquals("NGN1300C", new Symbol("NGN31|1300C", 2021, 8).getShortSymbolForDisplay(2021, 8));

        // August 31
        assertEquals("NGO1300C", new Symbol("NGQ31|1300C", 2021, 8).getShortSymbolForDisplay(2021, 8));

        // Sept 31
        assertEquals("NGP1300C", new Symbol("NGU31|1300C", 2021, 8).getShortSymbolForDisplay(2021, 8));

        // March 41
        assertEquals("NGC1300C", new Symbol("NGH41|1300C", 2021, 8).getShortSymbolForDisplay(2021, 8));

        // June 41
        assertEquals("NGI1300C", new Symbol("NGM41|1300C", 2021, 8).getShortSymbolForDisplay(2021, 8));

        // July 41
        assertEquals("NGL1300C", new Symbol("NGN41|1300C", 2021, 8).getShortSymbolForDisplay(2021, 8));

        assertEquals("CLT1165P", new Symbol("CLZ32|1165P", 2022, 9).getShortSymbolForDisplay(2022, 9));
        assertEquals("CLT1165P", new Symbol("CLT1165P", 2022, 9).getShortSymbolForDisplay(2022, 9));

        assertEquals("CLV1025Q", new Symbol("CLV23|1025P", 2022, 9).getShortSymbolForDisplay(2022, 9));
        assertEquals("CLV1025Q", new Symbol("CLV1025Q", 2022, 9).getShortSymbolForDisplay(2022, 9));

        assertEquals("MDUV2|3200P", new Symbol("MDUV2|3200P", 2022, 9).getShortSymbolForDisplay(2022, 9));
        assertEquals("MMCF3|9650C", new Symbol("MMCF3|9650C", 2022, 9).getShortSymbolForDisplay(2022, 9));
    }

    @Test
    public void testCashShortSymbol() {
        assertEquals("LZYY0", new Symbol("LZYY0").getShortSymbolForDisplay());
        assertEquals("LZYY0", new Symbol("LZYY00").getShortSymbolForDisplay());
    }

    @Test
    public void testFutureSpreadShortSymbol() {
        assertEquals("Its already short","_S_SP_ZSN3_ZSX3", new Symbol("_S_SP_ZSN3_ZSX3").getShortSymbolForDisplay());
        assertEquals("Long -> Short","_S_SP_ZSN3_ZSX3", new Symbol("_S_SP_ZSN23_ZSX23").getShortSymbolForDisplay());
    }
    ...
    public void getShortSymbol() {
        assertEquals("NGZ5",Symbol.getShortSymbolForDisplay("NGZ35"));
        assertEquals("NGO6",Symbol.getShortSymbolForDisplay("NGQ36"));

        assertEquals("NGF6",Symbol.getShortSymbolForDisplay("NGF36"));
        assertEquals("NGN6",Symbol.getShortSymbolForDisplay("NGN36"));

        assertEquals("NGN26",Symbol.getShortSymbolForDisplay("NGN26"));
