        ...
        try {
            ...
            case 37: // '%'
                ...
                if (message.charAt(1) == '<') {
                    ...
                    /*
                     * Compensate for a server bug that sends two % for HTTP sessions
                     */
...
//						msg._message = baOriginal;
    ...
    /*
     * This is still under construction.<br /> 0 - char subrecord<br /> 1 - (String)
     * Spread Type<br /> 2 - (Integer) Number of Legs<br /> 3 - (String[]) Legs<br
     * /> 4 - Parseable Message<br />
     * 
     * @param ba the ba
     * 
     * @return the object[]
